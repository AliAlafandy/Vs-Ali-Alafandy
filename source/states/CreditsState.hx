...
class CreditsState extends MusicBeatState {
	...
	override function create() {
		...
		var creditName:Array<Array<String>> = [
			...
			['Ali Alafandy', 'ali', 'Main of Mod', 'https://youtube.com/channel/UClK5uzYLZDUZmbI6O56J-QA', '00008D'],
			["Ali Alafandy's Server", 'discord', 'Do you want join?', 'https://discord.com/invite/ZTH67q6tPT', '5165F6'],
			[''],
